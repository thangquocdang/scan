...
class DocScanner(object):
    ...
    def __init__(self, MIN_QUAD_AREA_RATIO=0.7, MAX_QUAD_ANGLE_RANGE=40):
        """
        Args:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--images", default="./input_images", help="Directory of images to be scanned")
    parser.add_argument("--image", default=None, help="Path to single image to be scanned")
    parser.add_argument("--output", default="./output", help="Path to single image to be scanned")
